...
import { SquareChartContainer } from "../../../../components/Charts";
...
const FinanceUpcomingDuesDetail = () => {
  ...
  return (
    <Link to="/arrearDetail">
      {!isLoading ? (
        financialSummary && financialSummary.length ? (
          <SquareChartContainer
            THECHART={
              <>
                <DisplayTableInGrid data={financialSummary} />
              </>
            }
            title="Arrear Summary"
            link="/arrearDetail"
...
export default FinanceUpcomingDuesDetail;
