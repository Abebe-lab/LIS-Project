...
import { Home, Send, Print, Report, AddBusiness } from "@mui/icons-material";
import { SwipeRight, Logout, SettingsAccessibility, Map } from "@mui/icons-material";
...
export default function EICHeadLayout() {
