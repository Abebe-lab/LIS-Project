...
const Map = ({ children, zoom = null, center = [0, 0], extent = null }) => {
  ...
  useEffect(() => {
    ...
    if (zoom !== null) {
      ...
      viewOptions = { zoom: 5, center }; // Default zoom if neither zoom nor extent is provided
    }
  ...
  return (
    <MapContext.Provider value={mapContextValue}>
      <div id="map" ref={mapRef} style={{ width: "100%", height: "78%", padding: 0, margin: 0, position: "fixed" }}>
        {children}
      </div>
    </MapContext.Provider>
  );
