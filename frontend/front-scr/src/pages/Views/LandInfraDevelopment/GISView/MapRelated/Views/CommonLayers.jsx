...
//prettier-ignore
import { getParcelColorByOccupancy, getParcelColorByCountry, getParcelColorBySector } from "../Style/ParcelCatgorizationByColor.jsx";
...
//prettier-ignore
const CommonLayers = ({ park, blocks, parcels, sheds, otherInfras, greenAreas, buildings, importeds, roads, gcps,
                      wasteDisposals, waters, powers, communications, storages, surveyDatas, plans,zones, unapprovedImports,unapprovedSplitAndMerges,parcelsCategory = null, isEditable = false}) => {
    ...
    {park && (
       ...
       {blocks && (
        <VectorLayer
          ...
          style={(feature)=>getNonParcelFeatureStyle(feature,LAYER_COLORS.BLOCK.color,false)}
          zIndex={2}
        />
      )}
      {parcels && (
      ...
      {sheds && (
        <VectorLayer
          ...
          style={(feature)=>getNonParcelFeatureStyle(feature,LAYER_COLORS.SHED.color,false)}
          zIndex={3}
        />
      )}
      {buildings && (
        <VectorLayer
          ...
          style={(feature)=>getNonParcelFeatureStyle(feature,LAYER_COLORS.BUILDING.color,false,null,null,0.5,LAYER_COLORS.BUILDING.border)}
          zIndex={6}
        />
      )}
       {/*"PLANS AND OTHER"*/}
      ...
      {roads && (
        <VectorLayer
          ...
          style={(feature)=>getNonParcelFeatureStyle(feature,LAYER_COLORS.ROAD.color)}
          zIndex={15}
        />
      )}
      {otherInfras && (
        <VectorLayer
          ...
          style={(feature)=>getNonParcelFeatureStyle(feature,LAYER_COLORS.DEFAULT.color)}
          zIndex={15}
        />
      )}
      ...
      {zones && (
       ...
       {greenAreas && (
        <VectorLayer
          ...
          style={(feature)=>getNonParcelFeatureStyle(feature,LAYER_COLORS.GREEN_AREA.color,true,"id")}
          zIndex={16}
        />
      )}
      {/*"UTILITIES"*/}
      {waters && (
        <VectorLayer
          ...
          style={(feature)=>getNonParcelFeatureStyle(feature,LAYER_COLORS.WATER.color,true,"name","white",0.5)}
          zIndex={20}
        />
      )}
      {powers && (
        <VectorLayer
          ...
          style={(feature)=>getNonParcelFeatureStyle(feature,LAYER_COLORS.POWER.color,true,"id","white")}
          zIndex={20}
        />
      )}
      {communications && (
        <VectorLayer
          ...
          style={(feature)=>getNonParcelFeatureStyle(feature,LAYER_COLORS.COMMUNICATION.color,true,"id","white")}
          zIndex={20}
        />
      )}
      ...
      {wasteDisposals && (
        <VectorLayer
          ...
          style={(feature)=>getNonParcelFeatureStyle(feature, LAYER_COLORS.WASTE.color,true,"technology")}
          zIndex={20}
        />
      )}
      {gcps && (
